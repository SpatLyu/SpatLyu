...
[![ZhiHu
Badge](https://img.shields.io/badge/1128-blue?logo=zhihu&logoColor=blue&label=Follower&labelColor=white&color=blue)](https://www.zhihu.com/people/lyu-geosocial)
...
<a href="https://github.com/ausgis/esp"          ><img 
...
- 🏄‍ My research interests focus on **developing new spatial analysis
  methods based on spatial relationships** (such as *spatial
  dependence*, *spatial heterogeneity*, and *geographical similarity*)
  to support *urban sustainability* and *climate change mitigation*, and
  also include **developing the corresponding open source software**.

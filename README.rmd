...
<h1 align="center">Hi there👋, I'm Wenbo Lyu (吕文博) 🌌</h1>
...
[![ZhiHu Badge](https://img.shields.io/badge/1317-blue?logo=zhihu&logoColor=blue&label=Follower&labelColor=white&color=blue)](https://www.zhihu.com/people/lyu-geosocial)
...
- 🔬 Currently, my work centers on **information theory** for quantifying *information flow* and *variable interactions*, **dynamical systems theory** for detecting *dynamic causality*, **statistical physics methods** for characterizing *spatiotemporal processes*, as well as **virtual intervention computation** for inferring *interventional causality*. I aim to integrate these approaches to better understand and address complex challenges in *urban sustainability*, *climate change mitigation*, and broader global issues.
...
- 💬 Ping me about #GeoInformatics, #Statistics, #Causality, #R, #C++, #Python and anything you like!